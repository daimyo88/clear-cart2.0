        ...
        <div class="col-md-12">
            ...
            <?php if($shopping): ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            <span class="text-muted"><?php echo e(__('frontend/shop.order_date')); ?></span><?php echo e($shopping -> created_at->->format('d.m.Y')); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\web\clear-shop\resources\views/frontend/userpanel/order_details_.blade.php ENDPATH**/ ?>