<div>
    ...
    <div class="row d-flex flex-row align-items-center p-2 m-0 w-100" id="navbar">
        ...
        <div class="d-flex flex-row align-items-center ml-auto">
            ...
            {{-- <a wire:click='chatModalOpen()'>
                <i class=" fas fa-paperclip mx-3 text-muted d-none d-md-block"></i>
            </a> --}}

            {{-- <button data-toggle="tooltip" data-placement="top" title="Delete Ticket"
                wire:click.prevent="deleteTicketConfirm({{ $userTicket->id }})" class="btn btn-sm-my btn-danger">
    ...
    @if(isset($userTicket) && $userTicket->status == 'open')
    <form method="post">
        @csrf
        <!-- Input -->
